...
elseif($_REQUEST["do"]=="email"){
    echo $api->loginByEmail($_REQUEST["uin"],$_REQUEST["pwd"]);
...
elseif($_REQUEST["do"]=="daka"){
    echo $api->daka_new();
    
}
elseif($_REQUEST["do"]=="check"){
    echo $api->follow();
    
}

elseif($_REQUEST["do"]=="detail"){
    echo $api->detail($_REQUEST["uid"]);
    
}
elseif($_REQUEST["do"]=="listen"){
    echo $api->listen($_REQUEST["id"],$_REQUEST["time"]);
